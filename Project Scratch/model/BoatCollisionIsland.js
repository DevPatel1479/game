...
import * as CANNON from './Cannon/cannon-es/dist/cannon-es.js';
import CannonDebugger from './Cannon/cannon-es/dist/cannon-es-debugger.js';
...
sun = new THREE.Vector3();
    ...
    const islandBody = new CANNON.Body({
        mass: 0,
        shape: new CANNON.Box(new CANNON.Vec3(320,15,250)),
