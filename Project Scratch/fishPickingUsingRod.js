...
displayRandomPopup("Welcome to the Game Stranded !!! ", 'popup', 'popupText', 5000);
setTimeout(()=>{
  displayRandomPopup("W: Forward    S: Backward", 'popup', 'popupText', 5000);
}, 6000)
setTimeout(()=>{
  displayRandomPopup("A: Left    D: Right", 'popup', 'popupText', 5000);
}, 12000)

setTimeout(()=>{
  displayRandomPopup("Good Luck !!!", 'popup', 'popupText', 5000);
}, 18000)
